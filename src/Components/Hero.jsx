...
const Hero = () => {
    return (
        <section id="home" className="relative py-24 md:py-40">
            <div className="absolute inset-0 -z-10 bg-gradient-to-br from-indigo-50 via-white to-fuchsia-50 overflow-hidden">
            </div>
            <div className="container mx-auto px-6 text-center">
                <div className="max-w-4xl mx-auto">
                    <img src="https://placehold.co/144x144/6366F1/FFFFFF?text=LS&font=poppins" alt="Laxit Savaliya"
                        className="w-36 h-36 rounded-full mx-auto mb-6 shadow-2xl border-4 border-white" />
                    <p className="text-lg text-indigo-600 font-bold mb-2">HELLO, MY NAME IS</p>
                    <h1 className="text-5xl md:text-7xl font-extrabold text-slate-800 mb-4 leading-tight">Laxit Savaliya</h1>
                    <p className="text-2xl text-slate-600 font-medium mb-8">I'm a passionate Full Stack Developer.</p>
                    <p className="text-slate-500 max-w-2xl mx-auto mb-10">
                        I build secure, responsive, and scalable web applications, specializing in the MERN stack. I thrive on
                    ...
                    <div className="flex justify-center items-center flex-wrap gap-4">
                        ...
                        <a href={pdf} download="Laxit_Savaliya-Resume.pdf"
